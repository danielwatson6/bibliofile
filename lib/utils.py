...
### Independent collection of handytools
### Note: adding more is perfectly safe,
###  but deleting any existing ones will
###  mess with the other libraries.
...
# Encrypt a string with any alsgorithm
